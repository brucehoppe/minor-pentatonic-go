...
**Your backing band: [Rats of Chaos of Grid Lock](https://ratsofchaosofgridlock.bandcamp.com).** They are the band that plays along on the 12-bar trainer, and they are real: their first track, [Rats of Chaos of Grid Lock](https://ratsofchaosofgridlock.bandcamp.com/track/rats-of-chaos-of-grid-lock), is on Bandcamp, and you can follow them there. The synthesised drums, bass and keys in the app are their rhythm section.
...
![The Tuner of the Meridian Verse: the ship, its three tuning systems and the woman who keeps them from killing each other](docs/the-tuner-of-the-meridian-verse.jpg)
...
- **Band poster:** the 12-bar trainer opens with a riso-print gig poster for its backing band. **[Rats of Chaos of Grid Lock](https://ratsofchaosofgridlock.bandcamp.com) is a real band on Bandcamp** (their track [Rats of Chaos of Grid Lock](https://ratsofchaosofgridlock.bandcamp.com/track/rats-of-chaos-of-grid-lock) is there): the synthesised drums, bass and keys that play along are their rhythm section. The poster caption links to the band page. The poster is a 720px JPEG of about 130 kB, embedded and cached like the front-page graphic.
