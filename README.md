...
The Rats also tell a story. It is about a ship with three tuning systems and a woman whose job is to keep them from killing each other. It is the only thing they have ever finished, and they say the 12-bar trainer was written to keep it company. Also kept as its own file: [docs/the-tuner-of-the-meridian-verse.md](docs/the-tuner-of-the-meridian-verse.md).
