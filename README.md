...
- **Front-page graphic:** a riso-print kangaroo rat from Rats of Chaos of Grid Lock heads the page: an 800px JPEG of about 100 kB, embedded in the binary with the other images and served with a one-year immutable cache header.
