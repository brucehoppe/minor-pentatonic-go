...
test("the 12-bar trainer opens with the band's poster, small enough to load fast", () => {
  ...
  assert.match(trainer, /<figcaption>Your backing band: <b><a href="https:\/\/ratsofchaosofgridlock\.bandcamp\.com" target="_blank" rel="noopener">Rats of Chaos of Grid Lock<\/a><\/b> · <a href="https:\/\/ratsofchaosofgridlock\.bandcamp\.com\/track\/rats-of-chaos-of-grid-lock" target="_blank" rel="noopener">hear their track on Bandcamp<\/a><\/figcaption>/);
